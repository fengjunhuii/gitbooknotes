...
**关键学习链接：[Gitbook原始学习资料](https://toolchain.gitbook.com/)**
...
| 文件            | 描述                       |
| ------------- | ------------------------ |
| `book.json`   | [配置](https://toolchain.gitbook.com/config.html)数据 (**optional**)      |
| `README.md`   | 电子书的前言或简介 (**required**) |
| `SUMMARY.md`  | 电子书目录 (**optional**)     |
| `GLOSSARY.md` | 词汇/注释[术语](https://toolchain.gitbook.com/lexicon.html)列表 (**optional**) |
...
GitBook 使用 `SUMMARY.md` 文件来定义**本书的章节和子章节**的结构。 `SUMMARY.md` 文件用于生成本书的目录。
