...
## plugins
插件及其配置在 `book.json` 中指定。有关详细信息。请参阅[插件部分](https://toolchain.gitbook.com/plugins/)。

自 3.0.0 版本开始，GitBook 可以使用主题。有关详细信息，请参阅[主题部分](https://toolchain.gitbook.com/themes/)。
