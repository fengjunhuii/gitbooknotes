...
### [什么是 Github?](http://www.runoob.com/w3cnote_genre/code)
...
![Github增长量](http://www.runoob.com/wp-content/uploads/2014/05/github-repos.png)
...
```
git clone   /yourpath/repository 
```

如果是远端服务器上的仓库，你的命令会是这个样子：

```
git clone username@host:/yourpath/repository
```
...
![github仓库原理](http://www.runoob.com/wp-content/uploads/2014/05/trees.png)
